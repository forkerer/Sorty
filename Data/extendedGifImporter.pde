// SORRY FOR THAT, I HAVE NO IDEA HOW TO ADD "getAverageDelay" OTHER THAN THIS WAY :C
// https://github.com/01010101/GifAnimation
// ALL CREDITS GO TO ^


import java.awt.image.BufferedImage;
static public class Gif extends PImage implements PConstants, Runnable {
  ...
  public int getAverageDelay() {
    int average = 0;
     ...
     //return averageDelay/delays.length;
     return average/delays.length;
  }
